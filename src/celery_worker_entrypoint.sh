...
if [ ! -f /spacy_models/de_core_news_lg-3.2.0-py3-none-any.whl ]; then
  wget -P /spacy_models https://github.com/explosion/spacy-models/releases/download/de_core_news_lg-3.2.0/de_core_news_lg-3.2.0-py3-none-any.whl
else
  echo "spaCy model 'de_core_news_lg' already downloaded!"
fi
if [ ! -d /usr/local/lib/python3.9/site-packages/de_core_news_lg ]; then
  pip install /spacy_models/de_core_news_lg-3.2.0-py3-none-any.whl
fi

if [ ! -f /spacy_models/en_core_web_trf-3.2.0-py3-none-any.whl ]; then
   wget -P /spacy_models https://github.com/explosion/spacy-models/releases/download/en_core_web_trf-3.2.0/en_core_web_trf-3.2.0-py3-none-any.whl
else
  echo "spaCy model 'en_core_web_trf' already downloaded!"
fi
if [ ! -d /usr/local/lib/python3.9/site-packages/en_core_web_trf ]; then
  pip install /spacy_models/en_core_web_trf-3.2.0-py3-none-any.whl
fi
